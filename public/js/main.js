...
const getInfo = async(event) =>{
  ...
  // const apikey = "c4106c6cd8fa5c3348e3b69f28669797";
  ...
  if(cityVal === ""){
    ...
    try{
      let url = `https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=c4106c6cd8fa5c3348e3b69f28669797`;
